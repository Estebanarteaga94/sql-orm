...
- The wrapper-lifetime blocker for pending `Added`, `Modified`, and `Deleted` work has been removed, and final Stage 21 validation plus runtime coverage are recorded. The public experimental label remains until the release-level compatibility decision is made explicitly.
